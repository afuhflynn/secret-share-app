        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Create your first secret to get started.</p>
          ...
          {secrets.map((secret) => (
            <Card key={secret.id}>
              <CardHeader>
                ...
                <CardDescription>Created on {new Date(secret.createdAt).toLocaleDateString()}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {secret.currentViews} {secret.maxViews ? `/ ${secret.maxViews}` : ""}
                    </span>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link href={`/dashboard/secret/${secret.id}/share`}>Share</Link>
                </Button>
              </CardFooter>
            </Card>
          ))}
