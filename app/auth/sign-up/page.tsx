...
export default function SignupPage() {
  ...
  async function handleOAuthSignup(provider: string) {
    ...
    try {
      // Demo mode - simulate OAuth signup
      await new Promise((resolve) => setTimeout(resolve, 1000));
  ...
  return (
    <div className="container flex h-screen w-screen flex-col items-center justify-center py-4 overflow-x-hidden">
      <Link
        href="/"
