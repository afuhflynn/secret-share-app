    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "You can contact our support team by emailing support@secretshare.example.com or by visiting our Support page. We aim to respond to all inquiries within 24 hours.",
        },
      ],
    },
  ];
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="p-6 mt-12 border rounded-lg shadow-sm bg-card">
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  ...
                  <Link
                    href="https://github.com/afuhflynns/secret-share-app.git"
                    target="_blank"
                  >
